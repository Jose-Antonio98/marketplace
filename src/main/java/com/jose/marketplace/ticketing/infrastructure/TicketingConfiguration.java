package com.jose.marketplace.ticketing.infrastructure;
...
@EnableJpaRepositories(basePackages = "com.jose.marketplace.ticketing", entityManagerFactoryRef = "ticketingEntityManagerFactory", transactionManagerRef = "ticketingTransactionManager")
@EnableRedisRepositories(basePackages = "com.jose.marketplace.ticketing", redisTemplateRef = "ticketingRedisTemplate")
public class TicketingConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean ticketingEntityManagerFactory(@Qualifier("ticketing") DataSource dataSource,
        ...
        return builder
                ...
                .packages("com.jose.marketplace.ticketing")
