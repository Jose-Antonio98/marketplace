package com.jose.marketplace.catalog.infrastructure.persistence.repository;

import com.jose.marketplace.catalog.domain.*;
...
public class MongoEventMetadataRepository implements EventMetadataRepository {
    ...
    private static EventMetadata mapper(com.jose.marketplace.catalog.infrastructure.persistence.entity.EventMetadata eventMetadata) {
    ...
    private static Seat mapper(com.jose.marketplace.catalog.infrastructure.persistence.entity.EventMetadata.Seat seat) {
        return new Seat(new SeatId(seat.getCode()), new SectorId(seat.getSectorName()));
    }

    private static Sector mapper(com.jose.marketplace.catalog.infrastructure.persistence.entity.EventMetadata.Sector sector) {
